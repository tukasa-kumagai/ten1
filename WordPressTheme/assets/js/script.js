...
function activateTab(hash) {
  ...
  $("[href=\"".concat(hash, "\"]")).parent().addClass("active"); // ハッシュ値に対応するタブに active クラスを追加
  ...
  details.forEach(function (elem) {
    ...
    summary.addEventListener('click', function (e) {
      ...
      if (elem.open) {
        ...
        var closeDetails = content.animate({
          opacity: [1, 0],
        ...
        var rotateIcon = summary.animate({
          rotate: ["90deg", "0deg"]
        }, {
          duration: 300,
        ...
        closeDetails.onfinish = function () {
        ...
        // アイコンを回転させるアニメーションを実行（summary 要素）
        var _rotateIcon = summary.animate({
          rotate: ["0deg", "90deg"]
        }, {
          duration: 300,
          // summary 要素の疑似要素にアニメーションを適用
